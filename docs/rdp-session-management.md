...
### Решение 1. RemoteFX кодек в Remmina (`colordepth=0`)
...
В профиле `alt-rdp.remmina` установлено: `colordepth=0` (RemoteFX).

> В Remmina 1.4.x: `colordepth=0` = RemoteFX, `colordepth=65535` = Автоматическое (не RemoteFX).
...
> `colordepth=0` (RemoteFX) и `max_bpp=32` совместимы.
